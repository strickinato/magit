...
described in separate manuals: ~with-editor~[fn:info-with-editor],
~magit-popup~[fn:info-magit-popup], and
~magit-section~[fn:info-magit-section].

If you are trying to find an unused key that you can bound to a
command provided by your own Magit extension, then checkout the
"Plugin Dispatch Key Registry"[fn:key-registry].

[fn:info-with-editor] [[info:with-editor]]
[fn:info-magit-popup] [[info:magit-popup]]
[fn:info-magit-section] [[info:magit-section]]
[fn:key-registry] https://github.com/magit/magit/wiki/Plugin-Dispatch-Key-Registry
